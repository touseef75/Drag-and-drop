$(function() {
 ...
 function ondropTarget2(id , data , img ,droptarget ){
    ...
    if(document.getElementById("an1").style.display == "" &&  document.getElementById("an2").style.display == "" && document.getElementById("an3").style.display == "" &&  document.getElementById("an4").style.display == ""){
